    ...
    <div class="row">
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <p>Click button below to access your space</p>
                <p>
                    <a href="/teacher" class="btn btn-info btn-lg">Access my space</a>
                </p>
            </div>
        </div>
        @endif
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="jumbotron">
                        ...
                        <p>
                            <a href="{{route('register.teacher.form')}}" class="btn btn-primary btn-lg">Sign Up Here</a>
                        </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="jumbotron">
                        ...
                        <p>
                            <a href="{{route('register.form')}}" class="btn btn-primary btn-lg">Sign Up Here</a>
                        </p>
                        </div>
                    </div>
                </div>
